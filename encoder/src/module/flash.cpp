...
FLASH::FLASH(double dist0[2], double dist1[2], double dist2[2], double dist3[2], double dist4[2], double dist5[2], double angle0[2], double angle1[2], double angle2[2], EncoderCompute *Encoder1, EncoderCompute *Encoder2, Moteur moteur1, Moteur moteur2, Locator *locator) : encoder_compute1(Encoder1), encoder_compute2(Encoder2), moteur1(moteur1), moteur2(moteur2), locator(locator),
